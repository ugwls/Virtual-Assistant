    ...
    if __name__ == '__main__':
        while run == 1:
            ...
            app_string = ["open word", "open powerpoint", "open excel",
                          "open zoom", "open notepad",  "open chrome"]
            app_link = [r'\Microsoft Office Word 2007.lnk', r'\PowerPoint.lnk',
            ...
            if "goodbye" in statement or "good bye" in statement or "ok bye" in statement or "stop" in statement:
                speak('Your personal assistant ' +
                      name_assistant + ' is shutting down, bye bye')
                screen.destroy()
                break
            ...
            if 'wikipedia' in statement:
                ...
                weather_api_key = "c625c6d18fe685c9a672fece1c3e5eae"
                ...
                if response.status_code == 200:
                    ...
                    speak(
                        f"The temperature in {location} is {temp} degrees Celsius and the weather is {description}.")
                else:
...
def info():
    ...
    creator_label = Label(
        info_screen, text="Created by Aparna Jaiswal and Kumkum Bagha")
    creator_label.pack()
...
def main_screen():
    ...
    name_label = Label(text=name_assistant, width=300,
                       bg="white", fg="#7d91a9", font=("Poppins", 40))
    name_label.pack()
